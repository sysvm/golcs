...
func TestLCS(t *testing.T) {
	...
	for i, c := range cases {
		newLcs := New(c.left, c.right)
		actualPairs := newLcs.IndexPairs()
...
func TestContextCancel(t *testing.T) {
	...
	_, err := newLcs.LengthContext(ctx)
